      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-[0.02]">
          <div className="w-full h-full" style={{
            backgroundImage: 'repeating-linear-gradient(0deg, #050608 0px, #050608 1px, transparent 1px, transparent 80px), repeating-linear-gradient(90deg, #050608 0px, #050608 1px, transparent 1px, transparent 80px)',
          }} />
        </div>
          ...
          <div className="grid lg:grid-cols-[1.5fr,1fr] gap-12 lg:gap-20">
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#050608] via-[#1a1a1a] to-[#050608]" />
                ...
                <form onSubmit={handleSubmit} className="relative z-10 p-8 md:p-12 lg:p-16">
                  {isSubmitted ? (
                    <motion.div
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {contactData.form.fields.budget.options.map((option, i) => (
                ...
                {/* Glow Effect */}
                <motion.div
                  className="absolute -inset-[1px] bg-gradient-to-r from-[#F5EFE7]/20 via-transparent to-[#F5EFE7]/20 opacity-0 group-hover:opacity-100 pointer-events-none"
                  animate={{
            ...
            >
              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl mb-4">{contactData.office.title}</h3>
                    <p className="text-lg opacity-70 mb-2">{contactData.office.address}</p>
                    <p className="text-lg opacity-70 mb-4">{contactData.office.city}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 pt-6 border-t-2 border-[#050608] border-opacity-10">
                  ...
                  <div>
                    <p className="text-base uppercase tracking-wider opacity-50 mb-2">Часы работы</p>
                    <p className="text-lg opacity-70">{contactData.office.hours}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#050608] via-[#1a1a1a] to-[#050608] relative">
                  {/* Grid Pattern */}
                  ...
                  <div className="absolute bottom-4 left-4 text-[#F5EFE7] opacity-30 text-xs font-mono">
                    {contactData.office.coordinates.lat.toFixed(4)}, {contactData.office.coordinates.lng.toFixed(4)}
                  </div>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-32 md:py-40 bg-[#050608] text-[#F5EFE7] relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {contactData.cta.stats.map((stat, index) => (
                ...
                >
                  ...
                  <p className="text-base opacity-60 uppercase tracking-wider">{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="absolute inset-0 opacity-5">
          <motion.div
            ...
            style={{
              backgroundImage: 'repeating-linear-gradient(45deg, #F5EFE7 0px, #F5EFE7 2px, transparent 2px, transparent 60px)',
            }}
            animate={{
...
function ContactCard({ contact, index }: { contact: typeof contactData.contacts[0]; index: number }) {
  return (
    <motion.a
      href={contact.link}
      target="_blank"
    ...
    >
      ...
      <div className="flex-1">
        <p className="text-sm uppercase tracking-wider opacity-50 mb-2">{contact.label}</p>
        <p className="text-xl md:text-2xl group-hover:translate-x-2 transition-transform">{contact.value}</p>
      </div>
