...
import AIAutomationDisclaimerPage from "@/src/components/legal/AIAutomationDisclaimerPage";
...
export default function AIPolicyPage() {
  ...
  const localizedUrl =
    locale === "en" ? `${baseUrl}/ai-policy` : `${baseUrl}/${locale}/ai-policy`;
