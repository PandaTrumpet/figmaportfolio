...
//               url: t("schema.website.url"),
//               inLanguage: t("schema.website.inLanguage"),
//               potentialAction: {
//                 "@type": "SearchAction",
//                 target: `${t("schema.website.url")}/search?q={search_term_string}`,
...
export default function Home() {
  ...
  // Если английская версия без /en, оставляем так
  const localizedHomeUrl = locale === "en" ? baseUrl : `${baseUrl}/${locale}`;
