...
//   index,
// }: {
//   value: (typeof aboutData.values)[0];
//   index: number;
// }) {
...
//   index,
// }: {
//   point: (typeof aboutData.difference.points)[0];
//   index: number;
// }) {
//   const ref = useRef(null);
//   const isInView = useInView(ref, { once: true, margin: "-100px" });
...
//   index,
// }: {
//   member: (typeof aboutData.team)[0];
//   index: number;
// }) {
//   return (
//     <motion.div
...
//   index,
// }: {
//   achievement: (typeof aboutData.achievements.items)[0];
//   index: number;
// }) {
//   return (
//     <motion.div
