...
export const contactData: ContactData = {
  hero: {
    ...
    subtitle: 'Готовы начать свой проект? Свяжитесь с нами, и мы ответим в течение 24 часов.',
    badge: 'Get In Touch',
  },
  ...
  cta: {
    title: 'Не готовы отправить заявку?',
    subtitle: 'Скачайте наш portfolio PDF или запишитесь на бесплатную 30-минутную консультацию',
    stats: [
      { label: 'Ответ в течение', value: '24ч' },
      { label: 'Бесплатная консультация', value: '30мин' },
