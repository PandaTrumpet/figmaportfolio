...
export function buildReviewsData(t: TFn): ReviewsData {
  return {
    hero: {
      title: t("hero.title"),
      ...
      stats: [
        {
          ...
          value: t("hero.stats.0.value"),
          icon: Target,
        },
        {
          label: t("hero.stats.1.label"),
          value: t("hero.stats.1.value"),
          icon: Route,
        },
        {
          label: t("hero.stats.2.label"),
          value: t("hero.stats.2.value"),
          icon: Zap,
        },
        {
          label: t("hero.stats.3.label"),
          value: t("hero.stats.3.value"),
          icon: Eye,
        },
      ],
    },
    ...
    clientStories: [
      {
        name: t("clientStories.0.name"),
        role: t("clientStories.0.role"),
        company: t("clientStories.0.company"),
        avatar:
          "https://images.unsplash.com/photo-1581065178047-8ee15951ede6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080",
        story: t("clientStories.0.story"),
        challenge: t("clientStories.0.challenge"),
        solution: t("clientStories.0.solution"),
        results: [
          {
            metric: t("clientStories.0.results.0.metric"),
            value: t("clientStories.0.results.0.value"),
          },
          {
            metric: t("clientStories.0.results.1.metric"),
            value: t("clientStories.0.results.1.value"),
          },
          {
            metric: t("clientStories.0.results.2.metric"),
            value: t("clientStories.0.results.2.value"),
          },
          {
            metric: t("clientStories.0.results.3.metric"),
            value: t("clientStories.0.results.3.value"),
          },
        ],
        quote: t("clientStories.0.quote"),
        rating: 5,
        projectType: t("clientStories.0.projectType"),
        industry: t("clientStories.0.industry"),
      },
      {
        name: t("clientStories.1.name"),
        role: t("clientStories.1.role"),
        company: t("clientStories.1.company"),
        avatar:
          "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400",
        story: t("clientStories.1.story"),
        challenge: t("clientStories.1.challenge"),
        solution: t("clientStories.1.solution"),
        results: [
          {
            metric: t("clientStories.1.results.0.metric"),
            value: t("clientStories.1.results.0.value"),
          },
          {
            metric: t("clientStories.1.results.1.metric"),
            value: t("clientStories.1.results.1.value"),
          },
          {
            metric: t("clientStories.1.results.2.metric"),
            value: t("clientStories.1.results.2.value"),
          },
          {
            metric: t("clientStories.1.results.3.metric"),
            value: t("clientStories.1.results.3.value"),
          },
        ],
        quote: t("clientStories.1.quote"),
        rating: 5,
        projectType: t("clientStories.1.projectType"),
        industry: t("clientStories.1.industry"),
      },
      {
        name: t("clientStories.2.name"),
        role: t("clientStories.2.role"),
        company: t("clientStories.2.company"),
        avatar:
          "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400",
        story: t("clientStories.2.story"),
        challenge: t("clientStories.2.challenge"),
        solution: t("clientStories.2.solution"),
        results: [
          {
            metric: t("clientStories.2.results.0.metric"),
            value: t("clientStories.2.results.0.value"),
          },
          {
            metric: t("clientStories.2.results.1.metric"),
            value: t("clientStories.2.results.1.value"),
          },
          {
            metric: t("clientStories.2.results.2.metric"),
            value: t("clientStories.2.results.2.value"),
          },
          {
            metric: t("clientStories.2.results.3.metric"),
            value: t("clientStories.2.results.3.value"),
          },
        ],
        quote: t("clientStories.2.quote"),
        rating: 5,
        projectType: t("clientStories.2.projectType"),
        industry: t("clientStories.2.industry"),
      },
    ],

    // сейчас не используется на странице, но оставляю data готовым
    videoTestimonials: [
      {
        name: t("videoTestimonials.0.name"),
        role: t("videoTestimonials.0.role"),
        company: t("videoTestimonials.0.company"),
        thumbnail:
          "https://images.unsplash.com/photo-1618371441505-be18023fbb98?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
        videoUrl: "#",
        duration: t("videoTestimonials.0.duration"),
        quote: t("videoTestimonials.0.quote"),
        avatar:
          "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400",
      },
      {
        name: t("videoTestimonials.1.name"),
        role: t("videoTestimonials.1.role"),
        company: t("videoTestimonials.1.company"),
        thumbnail:
          "https://images.unsplash.com/photo-1576267423048-15c0040fec78?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
        videoUrl: "#",
        duration: t("videoTestimonials.1.duration"),
        quote: t("videoTestimonials.1.quote"),
        avatar:
          "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400",
      },
      {
        name: t("videoTestimonials.2.name"),
        role: t("videoTestimonials.2.role"),
        company: t("videoTestimonials.2.company"),
        thumbnail:
          "https://images.unsplash.com/photo-1698047681452-08eba22d0c64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
        videoUrl: "#",
        duration: t("videoTestimonials.2.duration"),
        quote: t("videoTestimonials.2.quote"),
        avatar:
          "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400",
      },
    ],
    ...
    reviews: [
      {
        ...
        company: t("reviews.0.company"),
        avatar:
          "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400",
        rating: 5,
        text: t("reviews.0.text"),
        date: t("reviews.0.date"),
        projectType: t("reviews.0.projectType"),
      },
      {
        name: t("reviews.1.name"),
        role: t("reviews.1.role"),
        company: t("reviews.1.company"),
        avatar:
          "https://images.unsplash.com/photo-1463453091185-61582044d556?w=400",
        rating: 5,
        text: t("reviews.1.text"),
        date: t("reviews.1.date"),
        projectType: t("reviews.1.projectType"),
      },
      {
        name: t("reviews.2.name"),
        role: t("reviews.2.role"),
        company: t("reviews.2.company"),
        avatar:
          "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400",
        rating: 5,
        text: t("reviews.2.text"),
        date: t("reviews.2.date"),
        projectType: t("reviews.2.projectType"),
      },
    ],

    platforms: [
      {
        name: t("platforms.0.name"),
        rating: t("platforms.0.rating"),
        reviewCount: t("platforms.0.reviewCount"),
        logo: "🔍",
      },
      {
        name: t("platforms.1.name"),
        rating: t("platforms.1.rating"),
        reviewCount: t("platforms.1.reviewCount"),
        logo: "💼",
      },
      {
        name: t("platforms.2.name"),
        rating: t("platforms.2.rating"),
        reviewCount: t("platforms.2.reviewCount"),
        logo: "🏆",
      },
      {
        name: t("platforms.3.name"),
        rating: t("platforms.3.rating"),
        reviewCount: t("platforms.3.reviewCount"),
        logo: "🎨",
      },
    ],
