...
//     // CSS — встроим прямо тут для максимальной точности
...
//         background: #2EE6FF;
//         border-radius: 50%;
//         box-shadow: 0 0 18px rgba(46,230,255,0.9);
//       }
...
//         height: 36px;
//         border-radius: 50%;
//         border: 2px solid rgba(46,230,255,0.75);
//         box-shadow: 0 0 26px rgba(46,230,255,0.85);
//         background: radial-gradient(circle, rgba(76,194,255,0.18), transparent 60%);
...
//       // Моментально двигаем оба элемента без React
