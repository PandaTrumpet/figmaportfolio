...
export function FinalCTA() {
  ...
  text-[clamp(0.98rem,0.55vw+0.88rem,1.15rem)] mb-10  mx-auto "
        ...
        "
          ...
          "
                ...
                <Mail className="relative z-10 h-5 w-5" aria-hidden="true" />
                <span className="relative z-10">{t("primaryButton")}</span>
                <ArrowRight
  ...
  "
    ...
    "
                ...
                <span className="relative z-10">{t("secondaryButton")}</span>
              </motion.span>
            </Link>
          </motion.div>
