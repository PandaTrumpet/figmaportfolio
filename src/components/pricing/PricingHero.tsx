...
//     target: sectionRef,
//     // ВАЖНО: end start — чтобы прогресс не стартовал сразу в 1 на hero
//     offset: ["start start", "end start"],
//   });

//   // Мягко уменьшаем прозрачность, но НЕ уходим в ноль (иначе текст “пропадает”)
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* title */}
          <h1 className="mx-auto max-w-5xl text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold tracking-tight leading-[1.02]">
          ...
          >
            <motion.a
              href="#contact"
              className="relative inline-flex items-center justify-center overflow-hidden rounded-full px-9 py-3.5 md:px-11 md:py-4 text-sm md:text-base font-medium text-[#050816] shadow-[0_0_45px_rgba(76,194,255,0.55)]"
            ...
            >
              ...
              <ArrowRight className="relative z-10 ml-2 h-4 w-4 md:h-5 md:w-5" />
            </motion.a>
