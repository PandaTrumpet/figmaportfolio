...
//           href="#contact"
//           className=" group
//     relative z-20 mt-7 inline-flex w-full items-center justify-center gap-2
      ...
      >
        ...
        <div className="relative z-20 flex items-start justify-between gap-4 mb-6">
          ...
          <motion.div
            className="
              ...
              overflow-hidden
              shadow-[0_0_40px_rgba(58,123,255,0.7)]
              shrink-0
            "
            animate={
              hovered
        ...
        <div className="relative z-20 mb-5">
          <div className="flex items-end gap-3">
            <div
              className="
                text-[40px] md:text-[48px] lg:text-[52px]
                leading-none
