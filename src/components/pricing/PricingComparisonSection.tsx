...
export function PricingComparisonSection() {
  ...
  const titleId = "pricing-comparison-title";
  const descId = "pricing-comparison-desc";
    ...
    >
      ...
      <PageContainer className="relative z-10 max-w-[1200px] text-[#F5EFE7]">
        ...
        <div className="sr-only">
          <h2 id={titleId}>{data.comparison.title}</h2>
          <p id={descId}>{t("comparisonSection.subtitle")}</p>
        </div>
        ...
        >
          ...
          >
            <motion.span className="relative inline-block">
              <span className="relative z-10">{data.comparison.title}</span>
