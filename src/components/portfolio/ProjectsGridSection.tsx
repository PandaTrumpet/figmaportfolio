...
// export function ProjectsGridSection({ projects }: { projects: any[] }) {
//   return (
//     <section className="px-6 md:px-12 lg:px-20 py-20 md:py-32">
//       <div className="max-w-[1600px] mx-auto">
//         {/* Counter */}
//         <div className="mb-12">
//           <p className="text-lg md:text-xl text-[#C7CEDF] opacity-70">
...
//             <p className="text-2xl text-[#C7CEDF] opacity-40">
//               Проекты не найдены
//             </p>
//           </div>
//         )}
