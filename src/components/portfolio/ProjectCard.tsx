...
export function ProjectCard({
  ...
  const projectLabel = `${project.title} — ${project.client}`;
    ...
    >
      <motion.div
        ...
        animate={
          reduce
            ? undefined
            : { opacity: isHovered ? 1 : 0.35, scale: isHovered ? 1.08 : 1 }
        }
      ...
      >
        <motion.div
          ...
          animate={reduce ? undefined : { opacity: isHovered ? 0.9 : 0.35 }}
        ...
        <div className="aspect-[4/3] overflow-hidden relative">
          ...
          {/* <motion.div
            ...
            animate={reduce ? undefined : { opacity: isHovered ? 1 : 0 }}
            transition={{ duration: 0.25 }}
          ...
          >
            ...
            {project.link && (
              <a
                ...
                aria-label={t("openProjectAria", { title: project.title })}
                className="relative z-10 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-[#F2F4FA] shadow-[0_0_40px_rgba(76,194,255,0.35)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8FDBFF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050816]"
              >
                <span
                  className="
            ...
            <>
              <div className="absolute inset-x-4 bottom-4 z-20 lg:hidden">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={t("openProjectAria", { title: project.title })}
                  className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-[rgba(5,8,22,0.82)] px-4 py-2.5 text-[#F2F4FA] shadow-[0_0_30px_rgba(76,194,255,0.25)] backdrop-blur-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8FDBFF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050816]"
                >
                  <span
                    className="
        ...
        <div className="p-6 md:p-7">
          ...
          >
            ...
            {project.type?.slice(0, 1).map((typeLabel: string) => (
              <span
                key={typeLabel}
                className="
                  text-[12px] md:text-[13px] lg:text-[14px]
