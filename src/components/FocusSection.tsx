...
//   min-h-[540px] md:min-h-[520px] lg:min-h-0
...
//             <motion.h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold leading-tight md:leading-[1.15] text-slate-50 tracking-tight mb-3">
//               <motion.span
//                 className="relative inline-block"
//                 initial="initial"
//                 whileHover="hover"
...
//               a11y={{ enabled: true }}
//               className="pb-10 overflow-hidden" // ✅ режем “край” соседней карточки
//               // style={{ paddingLeft: 16, paddingRight: 16 }} 
//               breakpoints={{
//                 // mobile: строго 1 карточка, без peek
//                 0: { slidesPerView: 1, spaceBetween: 16 },
//                 // tablet: 2 карточки (нормальная ширина, не тонкие)
...
//           {/* ✅ DESKTOP: Grid (с lg) — равная высота */}
//           <div className="hidden lg:grid lg:grid-cols-3 gap-8 lg:gap-10 items-stretch">
//             {services.map((service, index) => (
//               <ServiceCard
//                 key={service.title}
//                 service={service}
