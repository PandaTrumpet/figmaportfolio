...
export function GlobalLoaderInline({ open = true }: Props) {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className="fixed inset-0 z-[9999] grid place-items-center bg-[#050608]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 grid place-items-center">
                    ...
                    >
                      <div className="glitch-wrap absolute inset-0 rounded-2xl pointer-events-none">
                        <div className="glitch-layer glitch-cyan absolute inset-0 rounded-2xl" />
                        <div className="glitch-layer glitch-purple absolute inset-0 rounded-2xl" />
                      </div>
                      <div
                        className="
