...
type ContactCTAData = ContactData["cta"];

export function ContactCTA({ data }: { data: ContactCTAData }) {
  const reduce = useReducedMotion();

  const ctaHref = data.buttonHref || "#contact-form";
  const ctaLabel = data.buttonLabel;

  return (
    <section
      aria-labelledby="contact-cta-heading"
      className="
        relative overflow-visible bg-transparent text-[#F5EFE7]
        pt-10 pb-10
        md:pt-14 md:pb-14
        lg:pt-16 lg:pb-16
      "
    >
      ...
      >
        <div className="absolute -top-24 left-[8%] h-64 w-64 rounded-full bg-[radial-gradient(circle_at_center,_rgba(58,123,255,0.14),_transparent_70%)] blur-3xl" />
        <div className="absolute -bottom-28 right-[10%] h-72 w-72 rounded-full bg-[radial-gradient(circle_at_center,_rgba(76,194,255,0.12),_transparent_70%)] blur-3xl" />
        <div className="absolute top-1/2 left-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle_at_center,_rgba(155,93,255,0.10),_transparent_70%)] blur-3xl" />
      </div>
      ...
      <PageContainer className="relative z-10 max-w-[1200px]">
        <motion.div
          ...
          className="
            ...
            bg-gradient-to-b from-[#060A13] via-[#050816] to-[#02030A]
            p-8 shadow-[0_26px_90px_rgba(0,0,0,0.92)] backdrop-blur-xl
            md:p-12 lg:p-14
          "
        >
          <motion.div
          ...
          <div className="text-center">
            <h2
              ...
              className="
                mb-3 text-3xl font-semibold leading-tight text-slate-50
                md:text-4xl md:leading-[1.15]
            ...
            <motion.a
              ...
              className="
                ...
                overflow-hidden rounded-full
                px-10 py-4 md:px-12 md:py-4.5
                text-sm font-medium text-[#050816]
                shadow-[0_0_40px_rgba(76,194,255,0.55)]
            ...
            >
              ...
              <span
                ...
                className="
                  pointer-events-none absolute inset-0 rounded-full
                  bg-white/10 opacity-0 transition-opacity
              ...
              <div className="mt-12 grid gap-6 md:grid-cols-3 md:gap-8">
                {data.stats.map((stat, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true, margin: "-120px" }}
                    className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl md:p-7"
                  >
                    <div
                      aria-hidden="true"
                      className="pointer-events-none absolute -inset-10 bg-[radial-gradient(circle_at_center,_rgba(76,194,255,0.22),_transparent_70%)] opacity-40 blur-2xl"
                    />
                    <p className="relative z-10 mb-2 text-3xl font-semibold text-[#F2F4FA] md:text-4xl">
                      {stat.value}
                    </p>
                    <p className="relative z-10 text-[11px] tracking-[0.22em] text-[#AEB8CC] md:text-xs">
                      {stat.label}
                    </p>
                  </motion.div>
                ))}
