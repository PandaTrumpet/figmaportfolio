    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-[#050816]">
      ...
      <motion.div className="relative z-10 max-w-[1200px] mx-auto w-full px-6 md:px-12 lg:px-20 text-center">
        ...
        >
          ...
          >
            <div className="relative rounded-full border border-white/12 bg-gradient-to-b from-white/10 to-white/5 px-6 py-2.5 text-[11px] md:text-xs tracking-[0.22em] text-[#EAF2FF] shadow-[0_18px_60px_rgba(0,0,0,0.75)] backdrop-blur-xl">
            
              <div className="pointer-events-none absolute -inset-[10px] rounded-full bg-[radial-gradient(circle_at_center,_rgba(76,194,255,0.35),_transparent_70%)] blur-2xl opacity-70" />
