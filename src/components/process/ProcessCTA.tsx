...
export function ProcessCTA() {
  ...
  return (
    <section
      ...
      aria-describedby="process-cta-subtitle process-cta-note"
      className="relative  pt-10 pb-10
        md:pt-14 md:pb-14
        lg:pt-16 lg:pb-16 overflow-visible text-[#F5EFE7]"
    >
      ...
      >
        ...
        {/* subtle grid (GPU-friendly: move layer via transform, not backgroundPosition) */}
        <div className="absolute inset-0 opacity-[0.045] overflow-hidden transform-gpu">
          <motion.div
      ...
      <PageContainer className="max-w-[1200px]">
        <div className="relative z-10">
          ...
          >
            {/* icon row */}
            <div
              className="flex items-center justify-center gap-4 md:gap-6 mb-10 md:mb-12"
              aria-hidden="true"
            >
              <FloatingIcon
                icon={
                  <Target
                    className="h-6 w-6 md:h-7 md:w-7 text-[#EAF2FF]"
                    aria-hidden="true"
                  />
                }
                delay={0}
  ...
  text-[clamp(0.98rem,0.55vw+0.88rem,1.15rem)] mx-auto "
    ...
    "
      ...
      "
                  ...
                  <ArrowRight
                    className="relative z-10 h-5 w-5 md:h-6 md:w-6 transition-transform group-hover:translate-x-1"
                    aria-hidden="true"
                  />
                </motion.span>
              </Link>
            ...
            <p
              id="process-cta-note"
              className="mt-6 text-xs md:text-sm text-[#C7CEDF]/75"
            >
              {t("cta.note")}
            </p>
          </motion.div>
