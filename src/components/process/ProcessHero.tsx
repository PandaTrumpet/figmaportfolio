...
// Второй вариант (с оптимизацией для мобильных устройств и улучшенной доступностью)
...
//                 }
//               >
//                 <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/5 md:backdrop-blur-xl">
//                   <div
//                     aria-hidden="true"
//                     className="hidden md:block pointer-events-none absolute -inset-3 rounded-2xl
//                     bg-[radial-gradient(circle_at_center,_rgba(58,123,255,0.35),_transparent_70%)]
//                     blur-2xl opacity-70"
//                   />
//                   <ChevronDown
...
// Третий вариант (с добавлением анимации при загрузке и оптимизацией для мобильных устройств)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden md:block absolute inset-0 opacity-[0.08] [background-image:linear-gradient(rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] [background-size:64px_64px]" />
      ...
      <PageContainer className="relative z-10 w-full max-w-[1200px]">
        <motion.div className="w-full" style={reduce ? undefined : { opacity }}>
          <div className="min-h-[calc(100svh-6rem)] grid place-items-center">
            <motion.div
              ...
              transition={
                reduce
                  ? { duration: 0 }
                  : { duration: 0.85, delay: 0.1, ease: EASE }
              }
              className="w-full flex flex-col items-center text-center"
            >
              <p className="mb-4 md:mb-5 text-[0.78rem] sm:text-[0.82rem] md:text-[0.9rem] font-medium uppercase tracking-[0.22em] text-[#8FDBFF]">
                {data.badge}
              </p>
              ...
              <motion.button
                ...
                aria-label={t("hero.scrollAria")}
                className="
                  inline-flex flex-col items-center gap-3 rounded-2xl
                  focus-visible:outline-none
                  focus-visible:ring-2 focus-visible:ring-[#4CC2FF]/70
                  focus-visible:ring-offset-2 focus-visible:ring-offset-[#020410]
                "
              ...
              >
                <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/5">
                  <ChevronDown
                    aria-hidden="true"
                    className="h-6 w-6 text-[#E8F2FF] opacity-75"
                  />
                </div>
