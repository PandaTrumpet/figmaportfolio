...
//         <div className="absolute top-1/2 -right-40 h-[620px] w-[620px] bg-[radial-gradient(circle_at_center,_#4CC2FF44,_transparent_70%)] blur-3xl" />
//       </div>
...
//             <br />
//             <span className="text-[#F5EFE7] ">Вы выбираете систему роста.</span>
//           </h1>
