...
//   return (
//     <section className="bg-[#050816] px-6 md:px-12 lg:px-20 py-24">
//       <div className="max-w-[1000px] mx-auto">
//         <h2 className="text-2xl md:text-4xl font-semibold text-[#F5EFE7] mb-8">
//           Почему это работает
//         </h2>

//         <ul className="space-y-4 text-[#C7CEDF] text-base md:text-lg">
//           <li>— Мы не продаём “сайт”, мы строим путь клиента</li>
//           <li>— WhatsApp и автоматизация — часть системы, а не дополнение</li>
//           <li>— Вы понимаете, что получаете, ещё до старта</li>
//           <li>— Решения адаптированы под малый бизнес в Израиле</li>
//         </ul>
//       </div>
//     </section>
//   );
