        ...
        <div className="grid gap-6 md:grid-cols-2">
          {points.map((p, i) => (
            ...
            >
              ...
              {/* content */}
              <div className="relative z-10 transform-none will-change-auto">
                <div className="mb-3 text-[11px] uppercase tracking-wider text-[#C7CEDF] opacity-60 group-hover:opacity-90">
                  0{i + 1}
                </div>

                <h3 className="text-lg md:text-2xl font-semibold text-[#F5EFE7] mb-3">
                  {p.title}
                </h3>

                <p className="text-[#C7CEDF] text-sm md:text-base leading-relaxed opacity-90">
                  {p.text}
                </p>
              </div>
            </motion.div>
